...
#'
#' @description Returns the attribute values of a node set as data frame.
#'
...
#'
#' @note This is an auxiliary function used in several other functins of the bRasilLeg package
#'
#' @import httr XML
#'
